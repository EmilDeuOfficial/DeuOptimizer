...
:: ============================================================
cls
powershell -NoProfile -Command "Write-Host; Write-Host '  ==========================================' -ForegroundColor DarkGray; Write-Host '    !SI_TITLE!' -ForegroundColor White; Write-Host '  ==========================================' -ForegroundColor DarkGray; Write-Host; $os=(Get-CimInstance Win32_OperatingSystem); $cpu=(Get-CimInstance Win32_Processor); $gpu=(Get-CimInstance Win32_VideoController | Select-Object -First 1); $cs=(Get-CimInstance Win32_ComputerSystem); Write-Host ('   OS:           ' + $os.Caption) -ForegroundColor Gray; Write-Host ('   CPU:          ' + $cpu.Name) -ForegroundColor Gray; Write-Host ('   !SI_GPU!          ' + $gpu.Name) -ForegroundColor Gray; Write-Host ('   !SI_RAMF!     ' + [math]::Round($os.FreePhysicalMemory/1024) + ' MB') -ForegroundColor Green; Write-Host ('   !SI_RAMT!    ' + [math]::Round($cs.TotalPhysicalMemory/1GB,1) + ' GB') -ForegroundColor Gray; Write-Host ('   !SI_CPUL!     ' + $cpu.LoadPercentage + '%%') -ForegroundColor Yellow; Write-Host; Write-Host '  ==========================================' -ForegroundColor DarkGray; Write-Host; Write-Host '   [0]  !C_BACK!' -ForegroundColor DarkGray; Write-Host"
call :READ_KEY
goto MAIN_MENU
